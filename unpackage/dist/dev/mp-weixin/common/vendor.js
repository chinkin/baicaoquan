...
/* 4 */
/*!*************************************************************!*\
  !*** C:/Users/I028484/WeChatProjects/baicaoquan/pages.json ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 9 */
/*!*****************************************************************!*\
  !*** C:/Users/I028484/WeChatProjects/baicaoquan/store/index.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _service = _interopRequireDefault(__webpack_require__(/*! ./api/service */ 11));
var types = _interopRequireWildcard(__webpack_require__(/*! ./types */ 13));var _mutations;function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {};if (desc.get || desc.set) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var store = new _vuex.default.Store({
  ...
  types.RECEIVE_CATEGORIES, function (state, _ref) {var oCategories = _ref.oCategories;
    state.categories = oCategories;
  }), _defineProperty(_mutations,
  types.RECEIVE_PRODUCTS, function (state, _ref2) {var oProducts = _ref2.oProducts;
    state.products = oProducts;
  }), _mutations),

  getters: {
    categories: function categories(state) {return state.categories;},
    cateProducts: function cateProducts(state) {return state.cateProducts;},
    products: function products(state) {return state.products;} },

  actions: {
    getCategories: function getCategories(_ref3) {var commit = _ref3.commit;
      _service.default.getCategories(function (oCategories) {
        commit(types.RECEIVE_CATEGORIES, { oCategories: oCategories });
      });
    },

    getCategoryProducts: function getCategoryProducts(_ref4, oParam) {var commit = _ref4.commit;
      if (!oParam.id || oParam.id === '') return;
      oParam.expands = 'products';
      return new Promise(function (resolve, reject) {
        _service.default.getCategoryProducts(oParam, function (oCateProducts) {
          resolve(oCateProducts);
        });
      });
    },

    getProducts: function getProducts(_ref5) {var commit = _ref5.commit;
      _service.default.getProducts(function (oProducts) {
        commit(types.RECEIVE_PRODUCTS, { oProducts: oProducts });
      });
    },

    getProduct: function getProduct(_ref6, oParam) {var commit = _ref6.commit;
      if (!oParam.id || oParam.id === '') return;
      oParam.expands = 'productdetails,productspecs';
      return new Promise(function (resolve, reject) {
        _service.default.getProduct(oParam, function (oProduct) {
          resolve(oProduct);
        });
      });
    } } });var _default =
...
/* 11 */
/*!***********************************************************************!*\
  !*** C:/Users/I028484/WeChatProjects/baicaoquan/store/api/service.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! ../../commons/http.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var AUTH_TOKEN = "X-Auth-Token";
var aUrl = "api/";
var fUrl = "func/";

_http.default.setBaseUrl("http://localhost:8088/book");
//http.header['comp'] = "cjx913"
if (uni.getStorageSync(AUTH_TOKEN)) {
  _http.default.header[AUTH_TOKEN] = uni.getStorageSync(AUTH_TOKEN);
}

_http.default.beforeResponseFilter = function (res) {
  //X-Auth-Token
  if (res.header) {
    var respXAuthToken = res.header[AUTH_TOKEN.toLocaleLowerCase()];
    if (respXAuthToken) {
      uni.setStorageSync(AUTH_TOKEN, respXAuthToken);
      _http.default.header[AUTH_TOKEN] = respXAuthToken;
    }
  }
  return res;
};var _default =
...
{
  getRequest: function getRequest(url, cb, fnFailCb) {
  ...
  postRequest: function postRequest(url, oData, cb, fnFailCb) {
    _http.default.post(url, oData).
    then(function (res) {
      if (res.statusCode >= 200 && res.statusCode < 300) {
        console.info(res.data);
        cb(res.data);
  ...
  putRequest: function putRequest(url, oData, cb, fnFailCb) {
    _http.default.put(url, oData).
    then(function (res) {
      if (res.statusCode >= 200 && res.statusCode < 300) {
        console.info(res.data);
        cb(res.data);
  ...
  deleteRequest: function deleteRequest(url, oData, cb) {
    _http.default.delete(url, oData).
    then(function (res) {
      if (res.statusCode >= 200 && res.statusCode < 300) {
        console.info(res.data);
        cb(res.data);
  ...
  getCategories: function getCategories(cb) {
    var requestUrl = aUrl + 'categories';
    return this.getRequest(requestUrl, cb);
  },

  getCategoryProducts: function getCategoryProducts(oCategory, cb) {
    var requestUrl = aUrl + 'categories(' + oCategory.id + ')?_expand=' + oCategory.expands;
    return this.getRequest(requestUrl, cb);
  },

  getProducts: function getProducts(cb) {
    var requestUrl = aUrl + 'products';
    return this.getRequest(requestUrl, cb);
  },

  getProduct: function getProduct(oProduct, cb) {
    var requestUrl = aUrl + 'products(' + oProduct.id + ')?_expand=' + oProduct.expands;
    return this.getRequest(requestUrl, cb);
...
/* 12 */
/*!******************************************************************!*\
  !*** C:/Users/I028484/WeChatProjects/baicaoquan/commons/http.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var http = {
  ...
  'header': {},
  'beforeRequestFilter': function beforeRequestFilter(config) {return config;},
  'beforeResponseFilter': function beforeResponseFilter(res) {return res;},
  'afterResponseFilter': function afterResponseFilter(successResult) {},
  'request': request,
  'get': get,
  'post': post,
  'put': put,
...
function request(con) {
  ...
  var config = {
    ...
    success: con.success ? function (res) {
      http.afterResponseFilter(con.success(http.beforeResponseFilter(res)));
    } : null,
    fail: con.fail ? function (res) {
      con.fail(res);
    } : null,
    complete: con.complete ? function (res) {
      con.complete(res);
    } : null };
...
function get(url, con) {
  var conf = {};
  if (con && typeof con == 'function') {
    conf.success = con;
  } else if (con && typeof con == 'object') {
    conf = con;
  }
...
function del(url, data, con, success) {
  var conf = {};
  if (con && typeof con == 'function') {
    conf.success = con;
  } else if (con && typeof con == 'object') {
...
/* 13 */
/*!*****************************************************************!*\
  !*** C:/Users/I028484/WeChatProjects/baicaoquan/store/types.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.RECEIVE_PRODUCTS = exports.RECEIVE_CATEGORYPRODUCTS = exports.RECEIVE_CATEGORIES = void 0;var RECEIVE_CATEGORIES = 'RECEIVE_CATEGORIES';exports.RECEIVE_CATEGORIES = RECEIVE_CATEGORIES;
var RECEIVE_CATEGORYPRODUCTS = 'RECEIVE_CATEGORYPRODUCTS';exports.RECEIVE_CATEGORYPRODUCTS = RECEIVE_CATEGORYPRODUCTS;
var RECEIVE_PRODUCTS = 'RECEIVE_PRODUCTS';exports.RECEIVE_PRODUCTS = RECEIVE_PRODUCTS;
...
/* 20 */
/*!**********************************************************!*\
  !*** C:/Users/I028484/WeChatProjects/baicaoquan/Json.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var userInfo = {
  ...
  /* 首页轮播图 */ };
var carouselList = [{
  src: "/book/media/carousel/banner1.jpg",
  background: "rgb(203, 87, 60)" },

{
  src: "/book/media/carousel/banner2.jpg",
  background: "rgb(205, 215, 218)" },

{
  src: "/book/media/carousel/banner3.jpg",
  background: "rgb(203, 87, 60)" },

{
  src: "/book/media/carousel/banner4.jpg",
  background: "rgb(205, 215, 218)" },

{
  src: "/book/media/carousel/banner5.jpg",
